...
<td>
  <a target="_blank" href="https://github.com/tensorflow/ranking/tree/master/tensorflow_ranking/python/keras/layers.py#L171-L258">
...
<code>tfr.keras.layers.RestoreList(
    name: Optional[str] = None, by_scatter: bool = False, **kwargs
)
</code></pre>
...
<a target="_blank" class="external" href="https://github.com/tensorflow/ranking/tree/master/tensorflow_ranking/python/keras/layers.py#L253-L258">View
source</a>
